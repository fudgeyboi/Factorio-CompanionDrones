...
local bot_item =
{
  ...
  icon = "__companion-drones__/drone-icon.png",
  icon_size = 200,
...
--inserter_beam.head =
--{
--  filename = "__companion-drones__/data//hr-fast-inserter-hand-closed.png",
--  priority = "extra-high",
--  width = 164,
--  height = 72,
--  scale = 0.25
...
--inserter_beam.body =
--{
--  filename = "__companion-drones__/data//hr-fast-inserter-hand-base.png",
--  priority = "extra-high",
--  height = 32,
--  width = 136,
--  scale = 0.25
...
local drone =
{
  ...
  {
    filename = "__companion-drones__/drone-map.png",
    flags = {"icon"},
    size = {128, 128},
    scale = 0.25
  }
...
local drone_item =
{
  ...
  name = "companion",
  icon = "__companion-drones__/drone-icon.png",
  icon_tintable = "__companion-drones__/drone-icon-tintable.png",
  icon_tintable_mask = "__companion-drones__/drone-icon-mask.png",
  icon_size = 200,
  subgroup = "companion",
...
local attack_icon =
{
  filename = "__companion-drones__/drone-attack-shortcut.png",
...
{
  filename = "__companion-drones__/drone-attack-shortcut-disabled.png",
  priority = "extra-high-no-scale",
  size = 200,
  scale = 1,
  flags = {"icon"},
...
local attack_shortcut =
{
  ...
  action = "lua",
  style = "default",
  icon = "__companion-drones__/drone-attack-shortcut.png",
  icon_size = 200,
  small_icon = "__companion-drones__/drone-attack-shortcut.png",
  small_icon_size = 200,
  toggleable = true
}
...
{
  filename = "__companion-drones__/drone-construction-shortcut.png",
  priority = "extra-high-no-scale",
  size = 200,
  scale = 1,
  flags = {"icon"},
...
{
  filename = "__companion-drones__/drone-construction-shortcut-disabled.png",
  priority = "extra-high-no-scale",
  size = 200,
  scale = 1,
  flags = {"icon"},
...
local construct_shortcut =
{
  ...
  action = "lua",
  style = "default",
  icon = "__companion-drones__/drone-construction-shortcut.png",
  icon_size = 200,
  small_icon = "__companion-drones__/drone-construction-shortcut.png",
  small_icon_size = 200,
  toggleable = true
}
